...
public interface DateInterface {
     ...
     * the DateInterface object, the change will not be made. Essentially, the
     * change in dayOfMonth must not potentially be an inconsistent date. The
     * client must do some extra work to effect the change: for example, change
     * the month to 11 and then change month.
     *
